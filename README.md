...
- `lock_memory`: Lock the application memory using `mlockall()`. This option can reduce or even prevent page-faults. If it is enabled following additional parameters become available:
